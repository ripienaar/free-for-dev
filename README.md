...
## APIs, Data, and ML
  ...
  * * [QVeris](https://qveris.ai) - Capability routing network for AI agents to discover, inspect, and call 10,000+ real-world tools and live data through one unified protocol. Discover and Inspect are free forever. 1,000 credits on signup plus 100 daily login credits (resets next day). Only actual calls consume credits.
