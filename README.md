...
## APIs, Data, and ML
  ...
  * [Mimicry](https://mimicry.rest) - Instant CRUD mocking with dynamic data and a built-in "Chaos Mode" to test frontend resilience. A solo-developer personal project. Free tier available without registration (guest) and for registered users.
