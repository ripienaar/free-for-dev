...
## APIs, Data, and ML
  ...
  * [Live Tennis API](https://livetennisapi.com) - Real-time tennis scores, players and fixtures for ATP, WTA, Challenger and ITF over REST, WebSocket and MCP. The free tier includes 1,000 requests per day, no card required.
