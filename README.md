...
## APIs, Data, and ML
  ...
  * [IP.8080.LI](https://github.com/P1N2O/ip.8080.li#ip8080li) — Free IP Geolocation API - Allows unlimited free requests without rate limits supports Plain Text, JSON, JSONP or XML format.
