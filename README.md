...
## APIs, Data, and ML
  ...
  * [Mycelium](https://api.mycelium.global/docs/v1) - Open corporate carbon emissions database: search companies by name, LEI, ISIN or registration number and retrieve scope 1, 2 and 3 greenhouse gas disclosure history, with every figure tagged as company-reported or estimated. Free API keys on request with daily rate limits; also available as a free hosted MCP server at mycelium.global/mcp with no key required.
