...
## APIs, Data, and ML
  ...
  * [Vedika](https://vedika.io) — Vedic astrology API with birth charts, horoscopes, and compatibility matching. Free sandbox with unlimited requests for development and testing.
