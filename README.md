...
## APIs, Data, and ML
  ...
  * [Live Tennis API](https://livetennisapi.com) - Real-time tennis scores, players and fixtures for ATP, WTA, Challenger and ITF tournaments over REST and WebSocket. Free tier gives 1,000 requests/day, no card needed.
