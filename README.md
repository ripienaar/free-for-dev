...
## APIs, Data, and ML
  ...
  * [Serper](https://serper.dev) - Real-time Google Search API returning structured JSON for organic results, news, images, and more. Free plan includes 2,500 queries with no credit card required.
