...
## Generative AI
  ...
  * [PDF to Markdown Converter](https://pdf-to-markdown-gil.pages.dev) - Convert PDF files to clean Markdown in your browser for AI ingestion. Free, private, and offline; files are processed locally and nothing is uploaded.
