...
## Generative AI
  ...
  * [JahKnow API](https://api.websoquick.com) - OpenAI-compatible AI chat completions API (POST /v1/chat/completions). Self-hosted on private hardware, no data sold or shared. Free tier: 100 requests/day, no credit card required.
