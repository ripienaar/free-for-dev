...
## APIs, Data, and ML
  ...
  * [JSON Web Tools](https://jsonwebtools.com) - 18+ free client-side JSON tools: format, validate, diff, JWT decode, convert to TypeScript/Python/Java/Go/C#/PHP/Kotlin/Ruby/Rust, CSV/YAML/XML/SQL converters, repair, mock generator, JSONPath evaluator. No login, no tracking.
...
## Miscellaneous
  ...
  * [JSON Web Tools](https://jsonwebtools.com/) - Free online toolkit with 60+ JSON tools: validator, formatter, JWT decoder, diff, tree view, JSONPath query, schema validator, mock data generator, and converters (CSV, YAML, XML, TypeScript). No signup, 100% client-side.
