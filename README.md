...
## CMS
  ...
  * [NetlifyCMS](https://www.netlifycms.org/) - Headless CMS, git-based. You can add it to a site that's built with a common static site generator, like Jekyll, Hugo, NextJS, Gatsby... Alternatively, there are [several starter templates](https://www.netlifycms.org/docs/start-with-a-template/) that you can set-up and deploy with Netlify.
...
## Email
  ...
  * [mailsac.com](https://mailsac.com) - Free API and for temporary email testing, free public email hosting, outbound capture, email-to-slack/websocket/webhook (1,500 monthly API limit)
