...
## Generative AI
  ...
  * [Groq](https://groq.com/) - Fast AI inference API for open-source language models like Whisper , Llama etc. Free developer tier with rate-limited API access and no credit card required.
