...
## Screenshot APIs
  * [Abstract Screenshot API](https://www.abstractapi.com/website-screenshot-api) — Screenshot API handling resizing, multiple image formats, css injections and javascript rendering.
