...
## APIs, Data, and ML
  ...
  * [K-Data Gate](https://kdata-gate.vercel.app) - Korean market data API for AI agents and sellers: K-beauty/K-food product search, Naver search trends, Korean stocks with English DART summaries, real estate, tourism, and weather in English JSON. Free plan includes 100 calls/month; MCP server available.
