...
## Miscellaneous
  ...
  * [DevScratchpad](https://tools.saadengineer.works) - 19+ privacy-first developer utilities (JSON, JWT, cURL, Diff, etc.) running 100% offline in-browser with zero server transmission.
