...
## APIs, Data, and ML
  ...
  * [Frostbyte API](https://ozorown.github.io) — Unified API platform with 40+ services including IP geolocation, crypto prices, screenshots, web scraping, DNS lookup, code execution, and more. The free plan includes 200 API credits per month with no signup required.
