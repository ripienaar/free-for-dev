...
## APIs, Data, and ML
  ...
  * [ToolPipe](https://toolpipe.dev) - 220+ free developer tool APIs (JSON formatter, Base64 encoder/decoder, QR code generator, PDF tools, hash generator, UUID generator, URL shortener, SSL checker, DNS lookup, cron expression parser, and more). No signup, no API key required.
