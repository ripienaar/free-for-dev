...
## APIs, Data, and ML
  ...
  * [ToolForte](https://toolforte.com/developers) - REST API with 20 deterministic utility endpoints for developers and AI agents: IBAN validation, VAT calculation, Dutch public holidays and working days, cron parsing, regex testing, JSON/CSV/Base64 transforms, and Dutch test data generators. Free tier includes 1,000 calls/month, no credit card. Also exposes an MCP server for AI assistants.
