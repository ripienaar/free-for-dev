...
## Design and UI
  ...
  * [ImageMachine](https://imagemachinery.net) - 120+ browser-based image tools (resize, convert, compress, crop, QR code, EXIF, and more). All processing runs client-side in your browser; no uploads, no signup, completely free.
