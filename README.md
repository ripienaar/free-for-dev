...
## CMS
  ...
  * [Payload CMS](https://payloadcms.com) — Headless and self-hosted, JavaScript platform without limits. Build your content structures in code as simple configuration and develop beyond. Fully featured Personal plan includes no-caps GraphQL &amp; REST APIs, authentication, localization, file uploads and more for rich content experiences and application development.
