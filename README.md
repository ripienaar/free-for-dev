...
## Messaging and Streaming
  ...
  * [Vendel](https://vendel.cc) - SMS gateway that lets you send and receive SMS through your own Android phones or GSM modems as devices, with quota management, webhooks, API keys, and multi-user support. Free plan includes 70 SMS/month, 1 device, 1 scheduled SMS, and 1 integration.
