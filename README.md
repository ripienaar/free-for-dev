...
## IDE and Code Editing
  ...
  * [ForgeCode](https://forgecode.dev/) — AI-enabled pair programmer for Claude, GPT, O Series, Grok, Deepseek, Gemini and 300+ models. Works natively with your CLI and integrates seamlessly with any IDE. Free tier includes basic AI model access with local processing.
