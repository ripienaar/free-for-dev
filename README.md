...
## Storage and Media Processing
  ...
  * [OpenQR](https://openqr.uk) - Free, watermark-free QR code generator (PNG/SVG/PDF, no sign-up) plus a free REST API and MCP server for dynamic (editable) QR codes with scan analytics.
