...
## APIs, Data and ML
  ...
  * [CSV2GEO](https://csv2geo.com) — Creates a batch geocoding API endpoint with interactive map. Supports normal and reverse geocoding with rooftop results.  Coverage is worldwide and it provides daily free geocoding. 
