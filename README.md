...
## APIs, Data, and ML
  ...
  * [Meltema](https://meltema.com) - Multi-model weather forecast API (GFS, ECMWF IFS/AIFS, 31-member GEFS ensemble, NVIDIA Earth-2 AI models), scored against ground stations. Free: keyless /v1/point + /v1/grid + full OGC-EDR catalog at 60 requests per minute per IP; a free API key raises it to 120 requests per minute and unlocks station observations. Hosted MCP server at /mcp, no auth.
