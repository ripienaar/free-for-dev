...
## APIs, Data, and ML
  ...
  * [India PreValidate API](https://india-prevalidate-api-production.up.railway.app/) - Offline validation API for Indian financial identifiers (PAN, GST, IFSC, Aadhaar, UPI, Pincode, and more). 178K+ IFSC codes, 155K+ pincodes. Free tier available on RapidAPI with no credit card required.
