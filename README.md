...
## PaaS
  ...
  * [Open Source Cloud (OSC)](https://www.osaas.io/) - Managed open source services platform by Eyevinn Technology. Free Basic plan with 100 one-time tokens, full catalog access to 180+ services (databases, storage, media, dev tools), MCP server access, and community support. No time limit.
