...
## Testing
  ...
  * [Foglift](https://foglift.io) — Free SEO + GEO website analyzer that checks if AI search engines can find your site. 5 free scans/day across 5 categories (SEO, GEO, Performance, Security, Accessibility). Free public API available.
