...
## IDE and Code Editing
   ...
   * [HasteBin](https://hastebin.com/) - A simple web based "bin" to share/store your code, snippet, log, or any text file. Like PasteBin, Github Gist but simpler. Basically free to use. Also support API. Open source, in case you wish to self-host.
