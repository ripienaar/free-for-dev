...
## Web Hosting
  ...
  * [LinkWave Connect](https://en.linkwaveconnect.com.br/open-source/) - Free web hosting for open source projects. Supports both Static and Dynamic hosting. Support: Crontab, MySQL, PHP, Node.js, Python, etc.
