...
## PaaS
  ...
  * [host4.ai](https://host4.ai) - Cloud hosting with AI coding agents (Claude Code, Codex) preinstalled. Describe what you want in plain English and AI builds and deploys it live. Free tier includes 20 AI builder credits, full Linux terminal with SSH, and a `.host4.ai` subdomain.
