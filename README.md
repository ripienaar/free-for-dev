...
## APIs, Data, and ML
  ...
  * [TranscriptFetch](https://transcriptfetch.com) - Transcript API for YouTube, TikTok, Instagram and podcasts, returning clean text or timestamped JSON, with an MCP server for AI agents. The free tier includes 100 credits every month (1 credit per successful transcript, failures free), no credit card required.
