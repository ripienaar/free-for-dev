...
## Generative AI
  ...
  * [CloudAxis](https://cloudaxis.ai/) - Isolated cloud computer for AI agents: persistent desktop, real browser automation, file workspace, multi-agent workflows, and scheduled duties. Hosted models included (no API keys). Free tier: 100 AI credits/month, 30 browser minutes/month, 2 specialist agents, 2 scheduled jobs, 30-day chat history.
