...
## Generative AI
  ...
  * [Replicate](https://replicate.com) - Run open-source and commercial ML models via API. Free trial credit to start; pay-as-you-go for production usage across image, video, and language models.
