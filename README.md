...
## Generative AI
  ...
  * [Crevisto](https://crevisto.com) - 100+ dedicated AI image tools (headshots, logos, background removal, restoration) with an agent-first CLI and BYOK/OpenRouter support. Free tier includes 5 credits with no card required and no watermark; pay-per-use packs start at $2 and never expire.
