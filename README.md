...
## Generative AI
  ...
  * [GEOKit](https://geokit.site) - Free Generative Engine Optimization (GEO) & AI SEO toolkit with 20+ client-side utilities including llms.txt builder, AI robots.txt generator, JSON-LD Schema maker, and AI readiness grader. 100% free with no sign-up or credit card required. [#opensource](https://github.com/gstar-byte/geokit-cli)
