...
## DNS
  ...
  * [whois.blunek.services](https://whois.blunek.services) — Free WHOIS lookup, DNS records, SSL certificate checker, and email security (SPF/DMARC) validation. No account required for basic usage.
...
## Miscellaneous
  ...
  * [myip.blunek.services](https://myip.blunek.services) — Free IP address lookup with geolocation and ISP info. CLI-friendly (`curl myip.blunek.services`). JSON and plain text API endpoints. No signup, no tracking.
