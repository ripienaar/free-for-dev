...
## Code Quality
  ...
  * [Codiga](https://www.codiga.io/) - Codiga continously analyzes your code, finds code issues in many domains (security, safety, performance, code style, etc) and automates your code reviews.
