...
## APIs, Data, and ML
  ...
  * [Convert.rocks](https://www.convert.rocks) - Free online image converter (HEIC, AVIF, WebP to JPG/PNG) that runs 100% client-side using WebAssembly. No file uploads, no server processing — files never leave the browser. Unlimited conversions, no signup required.
