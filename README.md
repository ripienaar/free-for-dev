...
## Generative AI
  ...
  * [Bifrost by Maxim AI](https://getmaxim.ai/bifrost) - Bifrost is an open-source high-performance AI gateway that unifies access to 15+ providers (OpenAI, Anthropic, AWS Bedrock, Google Vertex, and more) through a single OpenAI-compatible API. Deploy in seconds with zero configuration and get automatic failover, load balancing, semantic caching, and enterprise-grade features. [#opensource](https://github.com/maximhq/bifrost)
