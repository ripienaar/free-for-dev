...
## Web Hosting
  * [Azure hosting](https://azure.microsoft.com/ru-ru/free/) - Zero cost web hosting, you can create up to ten web applications, based on PHP, Node.JS, etc. (there's in always free plan)
