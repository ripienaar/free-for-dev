...
## Generative AI
  ...
  * [MCP360](https://mcp360.ai) - A unified MCP gateway platform powering 100+ marketplace tools and custom MCPs. Connect your AI to 100+ tools through a single ready-to-use MCP platform. Run real workflows and extend capabilities without complex setup.
  * [mTarsier](https://mcp360.ai/mtarsier) - Open-source MCP server manager that helps developers manage and work with MCP servers more easily. A lightweight desktop app that auto-detects installed AI tools, centralizes scattered MCP configurations, and removes the need to manually edit JSON files across multiple environments. It runs locally, requires no account, and helps keep setups consistent, shareable, and easier to debug. [#opensource](https://github.com/mcp360/mTarsier)
...
## Miscellaneous
  ...
  * [JSON Formatter](https://delta4.io/tools/json-code-formatter) - Free online tool to format, validate, and beautify JSON instantly. Makes API responses, configs, and schemas easier to read and debug.
