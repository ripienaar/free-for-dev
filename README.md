...
## Generative AI
  ...
  * [stillworks](https://stillworks.supercapybara.com) - Live-probed list of LLM API endpoints that answer without a key. Every entry is a real chat completion sent on a schedule, failures published beside successes, and `/api/llm/up` returns the working ones ranked so your code can fall through to the next. Entirely free, no account. [#opensource](https://github.com/bon5co/stillworks)
