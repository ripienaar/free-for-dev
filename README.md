...
## Generative AI
  ...
  * [LumanexAI](https://app.lumanex.it/ai) - AI assistant for technical tasks, development workflows, and automation. Free plan available (includes all features, such as Chat, Code Agent, with fair use limits).
