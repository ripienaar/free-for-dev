...
## APIs, Data, and ML
  ...
  * [Statistics of the World API](https://statisticsoftheworld.com/api-docs) - Free REST API for global economic data. 440+ indicators (GDP, inflation, population, health, trade, etc.) for 218 countries from IMF, World Bank, and WHO. No authentication required, unlimited requests.
