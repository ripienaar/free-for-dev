...
## APIs, Data, and ML
  ...
  * [ToolPipe](https://troops-submission-what-stays.trycloudflare.com) - 220+ free developer utility APIs in one REST endpoint covering JSON formatting, QR codes, hashing, UUID generation, DNS lookup, WHOIS, web scraping, PDF generation, SEO tools, fake data generation, and more. No API key required for the free tier. [API Docs](https://troops-submission-what-stays.trycloudflare.com/docs).
