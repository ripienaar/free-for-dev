...
## Generative AI
  ...
  * [fal.ai](https://fal.ai) - Generative media inference API for images, video, and audio models. Free tier available to start generating; paid usage scales with model compute.
