...
## APIs, Data, and ML
  ...
  * [Moonlora](https://moonlora.com/developers) - Free moon data API: phases, illumination, moon signs, full/new moon dates (1900–2100) and moonrise/moonset by coordinates. JSON + OpenAPI, plus a hosted MCP server for AI assistants. No API key, unlimited within fair use; requires an attribution link.
