...
## PaaS
  ...
  * [Clever Cloud](https://clever.cloud) - European PaaS with automated deployments, autoscaling, managed databases, and Git-based workflows. Includes €20 free credits at signup, a limited DEV plan with free MySQL and PostgreSQL databases, and free allowances for services like Cellar and FS Buckets.
  * [Choreo](https://wso2.com/choreo/) - AI-native internal developer platform as a service. The free tier includes up to 5 components and $100 credits per month, plus 1 Aiven-based Postgres for 7 days
...
## Managed Data Services
  ...
  * [CockroachDB Cloud](https://www.cockroachlabs.com/pricing/) - Free tier offers 50 million RUs and 10 GiB of storage (same as 15$ worth) free per month. ([What's the Request Units](https://www.cockroachlabs.com/docs/cockroachcloud/metrics-request-units.html)) (30 days only, then requires a card)
  ...
  * [Datastax Astra](https://astra.datastax.com/) - IBM's managed Cassandra with 5 DBs (2d idle timeout), 80GB total, $25 monthly credits & integrated CQL shell.
  * [filess.io](https://filess.io) - filess.io is a platform where you can create two databases with up to 10 MB per database of the following DBMS for free: MySQL, MariaDB, MongoDB, and PostgreSQL. (Unavailable after 30 days of inactivity)
  ...
  * [Neon](https://neon.tech/) - Managed PostgreSQL, 0.5 GB of storage per project, 100 Projects ,10 branches, Unlimited Databases, always-available primary branch ( Auto suspend after 5 minutes), 100 hours of Active time per month (total) for non-primary branch compute.
  ...
  * [Prisma Postgres](https://prisma.io/postgres) - Super fast hosted Postgres built on unikernels and running on bare metal, 500MB storage total, 5 databases, integrated with Prisma ORM.
  ...
  * [Rivestack](https://rivestack.io) - Managed PostgreSQL with pgvector optimized for AI workloads. The free tier includes 1 shared instance with 256MB RAM, 2GB storage, daily snapshots, 14-day point-in-time recovery, and a built-in SQL editor that converts search queries to vector embeddings.
  * [scalingo.com](https://scalingo.com/) - Primarily a PaaS but offers a 128MB to 192MB free tier of MySQL, PostgreSQL, or MongoDB (30d only)
  ...
  * [SkySQL](https://app.skysql.com/) - Serverless MySQL/MariaDB with 1 instance, 10GB & 10 compute hours per month.
  ...
  * [Turso by ChiselStrike](https://chiselstrike.com/) - Turso is SQLite Developer Experience in an Edge Database. Turso provides a Free Forever starter plan, 5 GB of total storage, Up to 100 databases, Up to 3 locations, 100M row reads per month, and Local development support with SQLite.
  * [Timescale Cloud](https://console.cloud.timescale.com/) - Managed Postgres with 2 DBs (750MB each, 3d idle timeout), plus integrated SQL console
  ...
  * [Vela Sandbox](https://demo.vela.run/) - Serverless Postgres with 100GB storage (total), unlimited branches, no public transfer, as well as 10GB of file storage for evaluation & testing only.
  * [Xata Lite](https://lite.xata.io/) - Xata Lite is a serverless database with built-in powerful search and analytics. One API, multiple type-safe client libraries, and optimized for your development workflow. The free plan provides 10 branches and 15 GB of storage without pausing or cold starts. (No longer available)
