...
## APIs, Data, and ML
  ...
  * [Auto.dev](https://auto.dev) — Automotive data APIs for AI agents. VIN decode, vehicle listings, payments, recalls, and specs via REST API, MCP tools, CLI, or SDK. Free tier available.
