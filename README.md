...
## APIs, Data, and ML
  ...
  * [Signbee](https://signb.ee) - Document signing API for AI agents. Send markdown or PDF for two-party e-signing with SHA-256 certified delivery. Available as MCP server and REST API. The free plan includes 5 documents per month with no API key required.
