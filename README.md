...
## APIs, Data, and ML
  ...
  * [x402 Crypto API](http://43.157.206.248:4020) - AI agent crypto data API with 3 free endpoints (Fear & Greed Index, gas prices, health check). 30+ paid endpoints covering prices, DEX pairs, DeFi analytics, wallet tracking, and whale alerts. Pay per request in USDC on Base via x402 protocol. No API keys needed.
