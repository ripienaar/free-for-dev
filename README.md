...
## Tools for Teams and Collaboration
  ...
  * [PRFlow](https://prflow.dev) - GitLab merge request notifications in Slack with live CI/CD pipeline status and two-way comment sync. Works with GitLab.com and self-managed GitLab. The free tier includes up to 3 users, unlimited repos, and unlimited Slack channels.
