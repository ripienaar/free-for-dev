...
## Storage and Media Processing
  ...
  * [filepost.dev](https://filepost.dev) - File upload REST API — POST a file, get back a permanent public CDN URL. Free tier includes 50 uploads/month with no file size restrictions on smaller files. Useful for automation workflows and apps that need to host files without configuring cloud storage.
