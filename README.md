...
## Code Generation
  ...
  * [Continue](https://github.com/continuedev/continue) - Continue keeps developers in flow. Our open-source VS Code and JetBrains extensions enable you to easily create your own modular AI software development system that you can improve. The free trial provides developers with 150 chat messages (using your choice of top LLMs from OpenAI, Meta, Anthropic, and more) before you need to bring your own compute / add your own API keys
