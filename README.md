...
## Security and PKI
  ...
  * [PasteGuard](https://pasteguard-exp2.netlify.app) - Free client-side scanner for API keys, tokens, private keys, and PII before pasting into AI chats. Runs entirely in the browser; nothing is uploaded.
