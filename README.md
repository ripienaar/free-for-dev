 ...
 * [CloudAxis](https://cloudaxis.ai/) - Managed cloud environment for running browser automation, code execution, and scheduled scripts. Gives each account a persistent desktop with a real browser (Playwright/CDP), file workspace, GitHub integration, cron-scheduled jobs, and web search. Free tier: 100 AI credits, 30 browser minutes, 5 code execution runs, and 2 scheduled jobs per month.
