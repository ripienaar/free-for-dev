...
## PaaS
  ...
  * [Nife.io](https://nife.io) - Developer friendly platform that can build docker containers and deploy serverless applications with CI/CD integartion from Github on any infratsructure, customers on cloud, on prem, private 5G, edge or cloud. Access to 500+ locations, free one app deployment for life. ( Startups and non profits can request for more
