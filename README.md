...
## Monitoring
  ...
  * [KubeStellar Console](https://console.kubestellar.io/) - Open source AI-powered multi-cluster Kubernetes dashboard. Free and self-hosted with real-time observability, CNCF integrations (Prometheus, Grafana, Argo, Kyverno, and 20+ others), and AI-guided cluster operations. CNCF Sandbox project.
