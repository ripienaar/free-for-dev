...
## Payment and Billing Integration
  ...
  * [FXpeek](https://fxpeek.com/en/api) - Source-linked historical reference exchange rates with a per-row source link, CSV/JSON export and an MCP server. Free API, no key required.
