...
* [SegmentLite](https://segmentlite-api-dfru.fly.dev) - Lightweight event routing and webhook fan-out API (alternative to Twilio Segment). Free tier includes 1,000 requests/month, sub-15ms background fan-out, and Python/Node.js SDKs.
