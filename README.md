...
## APIs, Data, and ML
  ...
  * [Atheris IP](https://atheris.ee/tools/ip) - Free, no-auth IP echo API returning your public IP and country code as plain text or JSON. CORS-open, no key, no rate limit.
