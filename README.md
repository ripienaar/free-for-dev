...
## Code Generation
  ...
  * [Continue](https://github.com/continuedev/continue) - Continue keeps developers in flow. Our open-source VS Code and JetBrains extensions enable you to easily create your own modular AI software development system that you can improve. All IDE extension features have an Apache 2.0 license and are free to use with your own compute / API keys
