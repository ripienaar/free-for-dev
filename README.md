...
## APIs, Data, and ML
  ...
  * [Liminal Labs](https://liminal-labs.pages.dev) - Crypto & DeFi data APIs: funding-rate arbitrage signals, Hyperliquid market data (OI + funding), perp basis APR, on-chain stablecoin yields, DeFi borrow rates, and Aave liquidation alerts. Free tier: 50 requests/month per API.
