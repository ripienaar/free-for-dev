...
- [Slai](https://slai.io) - Fast prototyping platform for machine learning applications. Build, test, and deploy machine learning apps on serverless GPUs. Developer plan includes 1 hour of free compute per month.
