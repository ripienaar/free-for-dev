...
## Forms
  ...
  * [Survicate](https://survicate.com/) — Collect feedback from all sources. Automatically analyze, categorize and consolidate it with Feedback Hub and AI Insights Assistant to extract intelligence and make quicker decisions. Connect with third-party tools using native integrations. Free Plan with email, website, in-product or mobile surveys. Free 10-day trial with all Business Plan features.
