...
## Miscellaneous
  ...
  * [opencode-remote-android](https://github.com/giuliastro/opencode-remote-android) - Free, open-source Android companion app for monitoring and controlling opencode AI coding agent sessions running on a remote server.
