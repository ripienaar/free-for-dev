...
## APIs, Data and ML
  ...
  * [Marvin-AI](https://marvin.apache.org/) - Marvin is a platform for facilitating the lifecycle management of Machine Learning projects. Through the use of pre-defined patterns and a HTTP execution server it allows developers to focus on the logic of data handling and algorithm evaluation and execution.
