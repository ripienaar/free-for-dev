...
## APIs, Data, and ML
  ...
  * [MCP360](https://mcp360.ai) – Unified gateway connecting AI agents to 100+ production-ready MCP tools (search, SEO, shopping, maps, media, finance, dev utilities) via one integration point, plus a Custom MCP Builder to turn any REST API into an MCP tool. Free tier includes 100 credits/month for 1 project.
