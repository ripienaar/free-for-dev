...
## Cloud management solutions
  ...
  * [ArchFormation](https://archformation.com) - Visually design cloud architectures and generate Terraform automatically. Free plan includes 1 user, 2 projects, 70 tokens (complexity units, e.g. Network + Database = 50), prebuilt templates and GitHub integration.
