...
## PaaS
  ...
  * [Deno Deploy](https://deno.com/deploy/) — Serverless platform based on Deno. Deployed to 25 Google Cloud regions globally. 50ms/request CPU time and 100,000 requests/day with a deno.dev subdomain, while in beta.
