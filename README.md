...
## Storage and Media Processing
  ...
  * [SammaPix](https://www.sammapix.com) — Free browser-based image optimizer with 20+ tools: compress, WebP convert, HEIC to JPG, batch resize, EXIF remover, duplicate finder. All processing runs locally in your browser — no server uploads. Unlimited use, no account required.
