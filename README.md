...
## APIs, Data, and ML
  ...
  * [Bargo Congress Trades API](https://www.bargo.ai/free-apis/congress) - U.S. House and Senate stock-trade disclosure API with per-trade performance. The free tier includes 30 keyless requests/day or 1,000 requests/day with a free API key, no card required.
