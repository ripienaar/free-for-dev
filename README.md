...
## Security and PKI
  ...
  * [SnapEnv](https://snapenv.io/) - Secure environment variable manager for dev teams and Linux servers. AES-256-GCM encryption at rest, per-project derived keys, CLI + Kubernetes operator, full audit log. Free plan includes 3 projects, 3 team members, and 3 environments per project, forever, no credit card required. Open source maintainers get 3 months of the Team plan (unlimited projects/members/environments) free with code `HELLOSNAP` at [dash.snapenv.io](https://dash.snapenv.io).
