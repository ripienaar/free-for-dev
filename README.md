...
## CMS
  ...
  * [Statamic](https://statamic.com/) - Organize and publish content with all 40+ fieldtypes. Unlimited collections & taxonomies. One (super) admin user account & content form. Built on top of Laravel. Statamic is a modern, clean, and highly adaptable CMS that can run full-stack, headless, on flat files or databases, & as an SSG.
