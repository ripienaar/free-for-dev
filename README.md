...
## Testing
  ...
  * [Cypress Recorder by Preflight](https://cypress.preflight.com/) - Create AI-powered Cypress Tests/POM models on your browser. It's open-source except for the AI part. It's free for up to 50 test creations with Self-healing scripts, Email, and Visual testing.
