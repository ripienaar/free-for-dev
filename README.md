...
## APIs, Data, and ML
  ...
  * [CoinBeacon](https://coinbeacon.io/docs/api) - Free crypto market data API: prices, market caps, funding rates, liquidations, OHLCV candles, screener and automated pattern detections. No API key or signup, 60-300 requests/minute.
