...
## Miscellaneous
  ...
  * [THEJORD](https://thejord.it) — Privacy-first developer tools suite with JSON formatter, Base64 encoder/decoder, Regex tester, Hash generator, PDF tools (merge, split, compress, edit), and more. All processing happens client-side with no data uploaded to servers. Completely free with no limits.
