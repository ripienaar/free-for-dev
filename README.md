...
## APIs, Data, and ML
  ...
  * [ToolPipe](https://github.com/COSAI-Labs/toolpipe-mcp-server) - 120+ free developer utility APIs: QR codes, JSON/CSV/XML processing, text analysis, hashing, DNS lookup, SSL checking, WHOIS, code review, fake data generation, and more. No signup required. Free tier with 100 calls/day. Also available as an MCP server for AI agents.
