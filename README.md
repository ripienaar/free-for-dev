...
## Analytics, Events and Statistics
  ...
  * [ExpenseEasy](https://www.expenseeasy.app/) — All-in-one money manager for budgeting, tracking & saving. Free forever for manual tracking. No login, no cloud, no bank connection. Add AI-powered receipt scanning and voice input for fast expense capture. Includes on-device insights and smart reminders to stay on budget
