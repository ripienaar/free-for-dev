...
## Storage and Media Processing
  ...
  * [SammaPix](https://www.sammapix.com) — Free browser-based image optimization with 20+ tools: compress, WebP convert, HEIC convert, AI rename, batch resize, EXIF remover. All processing happens locally in your browser — no uploads to servers. Free tier includes all tools with 10 AI credits/day.
