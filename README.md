...
## IDE and Code Editing
  ...
  * [Frontman](https://frontman.sh/) — Open-source AI coding agent that lives in your browser. Click any element, describe changes in plain English, and get real code edits with hot reload. Free and open source (Apache 2.0 / AGPL-3.0), users bring their own AI API key.
