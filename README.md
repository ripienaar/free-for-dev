...
## Testing
  ...
  * [TestCafe](https://devexpress.github.io/testcafe/) - Free and open source tool for web e2e testing with no limitations. 1 minute to setup (no WebDriver required), easy to use, cross-browser and cross-platform out-of-the box. Built-in free test parallelization. Modern JS/TS syntax. Advanced testing scenarios supported.
