...
## APIs, Data, and ML
  ...
  * [Compare JSON](https://comparejson.com) - An online tool for comparing differences between two JSON data structures, helping you quickly locate the differences in JSON data. The open source repository [compare-json](https://github.com/unitstack/compare-json) provides skill and MCP server for comparison, which can be used in agents.
