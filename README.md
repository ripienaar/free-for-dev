...
## APIs, Data, and ML
  ...
  * [JSON Mapper](https://jsonmapper.a7soft.com) - JSON Mapper is a browser-based tool that auto-generates transformation maps just by comparing two JSON examples.
