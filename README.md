...
## APIs, Data, and ML
  ...
  * [ToolPipe](https://toolpipe.sh) - 80+ free developer utility APIs including JSON processing, QR code generation, hashing, UUID, DNS lookup, PDF generation, image processing, and more. Free tier includes 100 API calls per day with no authentication required.
