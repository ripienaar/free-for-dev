...
## Monitoring
  ...
  * [Prismix](https://prismix.dev) - AI service status monitoring for 75+ providers (OpenAI, Anthropic, Gemini, etc.). Free tier includes real-time dashboard, public REST API (`/api/v1/statuses`), embeddable SVG badges, incident timeline, and RSS feed. No account required.
