 ...
 * [API Security Academy](https://escape.tech/academy/) - A free and interactive platform dedicated to learning how to fix vulnerabilities in GraphQL applications — all directly in your browser. 
