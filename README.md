...
## Testing
  ...
  * [Playwright](https://playwright.dev) - Batteries-included test automation framework for end-to-end testing. Its cross-platform, cross-browser, and cross-language, and includes helpful features like auto-waiting, web-first assertions, tracing, parallel test execution, HTML report and etc. Playwright is built to enable cross-browser web automation that is ever-green, capable, reliable and fast.
