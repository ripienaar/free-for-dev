...
## APIs, Data, and ML
  ...
  * [ToolPipe](https://toolpipe.dev) - Free developer utility API with 240+ endpoints including JSON/CSV conversion, QR codes, hashing, UUID generation, DNS lookup, base64, markdown rendering, JWT decoding, fake data, WHOIS, SEO analysis, and web scraping. No authentication required for basic usage. CORS enabled.
