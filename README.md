...
## APIs, Data, and ML
  ...
  * [MockBolt](https://mockbolt.com/) - Paste any JSON and get a live public mock API endpoint in seconds, no signup. Supports all HTTP methods, custom status codes and headers, response delay, and error simulation, plus a real-time request inspector. Free endpoints last 7 days and auto-renew with traffic; ready-made sample data endpoints (users, posts, todos) are also available.
