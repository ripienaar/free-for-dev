...
## Generative AI
  ...
  * * [MyStoryElf for Developers](https://mystoryelf.com/en/api) - Easy-to-use AI story generator with a free API tier for developers, where developers get 100 free stories a month through the API. Generate stories in any language and each story has 5 - 10 AI image generations and multiple illustration styles.
