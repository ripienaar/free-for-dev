...
## PaaS
  ...
  * [Napptive](https://napptive.com/) - A managed cloud-native application platform that simplifies the usage of Kubernetes by using the Open Model Application (OAM) abstraction. Free tier includes 1 CPU core, 4GB RAM, and 1GB ephemeral storage. Environments are reset every 24 hours.
