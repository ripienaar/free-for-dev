...
## Testing
  ...
  * [RatedWithAI](https://ratedwithai.com) — Free website accessibility scanner that checks against WCAG 2.1 and 2.2 Level AA. Provides a detailed compliance report with specific violations and remediation guidance. No signup required for free scans.
...
## Monitoring
  ...
  * [API Status Check](https://apistatuscheck.com) — Free real-time status monitoring for 250+ popular APIs and services. Includes uptime history, outage tracking, and status pages. No signup required.
