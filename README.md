...
## Generative AI
  ...
  * [Dev Brains AI](https://dev-brains-ai.com) - Free browser-based developer tools that turn plain-English descriptions into regex, SQL, cron expressions, READMEs, and more using AI. No signup, no paid tier, nothing pasted in is stored.
