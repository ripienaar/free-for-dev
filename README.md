...
## APIs, Data, and ML
  ...
  * [ShopSavvy](https://shopsavvy.com/data) - Product data API covering barcode/UPC/EAN/ASIN lookups, real-time pricing, and price history across tens of thousands of retailers. Free tier available for developers.
