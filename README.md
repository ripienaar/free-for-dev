...
## APIs, Data, and ML
  ...
  * [GcrawlAI](https://gcrawlai.com) - Open-source (MIT) web scraping API with SERP results, screenshots, URL-to-Markdown and prebuilt extractors. Failed requests aren't charged, and there is no credit system, so one request counts as one request. The free plan includes 200 requests per month, no credit card required.
