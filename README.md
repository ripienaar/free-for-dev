...
HTML Themes and UI Kits to create your applications faster!
  ...
  * [React Native Starter](https://flatlogic.com/templates/react-native-starter-free) — React Native Starter is a mobile application template that contains tens of ready-to-use components, pages and includes theme support! 
