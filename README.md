...
## APIs, Data, and ML
  ...
  * [SCALA Score API](https://score.get-scala.com) - Company data API to search 250M+ business records worldwide, returning revenue, employee count, and credit scores. Free tier includes 50 lookups per month with no signup or API key required. [API docs](https://github.com/Alessandro114/score-api-openapi).
