...
## PaaS
  ...
  * [Vercel Sandbox](https://vercel.com/sandbox/) - Persistent Amazon Linux sandboxes with 15GB snapshot to test code before deployments ([requires NPM package](https://vercel.com/docs/cli/install/)). Supports Docker (requires manual setup on sandboxes)
