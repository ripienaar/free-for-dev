...
## Miscellaneous
  ...
  * [Cobalt Studio Cold Email Generator](https://techchenko.github.io/cobaltstudio-products/tools/cold-email-generator/) - Generate 3 short cold emails + subject lines (no signup).
  * [Cobalt Studio Freelance Rate Calculator](https://techchenko.github.io/cobaltstudio-products/tools/rate-calculator/) - Calculate hourly and project rates based on your income goals, expenses, and billable hours.
  * [Cobalt Studio Templates Hub](https://techchenko.github.io/cobaltstudio-products/files/) - Free copy/paste templates (proposal, SOW, contract, invoice follow-ups, kickoff/status emails).
