...
## DBaaS
   ...
   * [Astra](https://astra.datastax.com/register) — Cloud Native Cassandra as a Service with [40GB free tier](https://docs.datastax.com/en/astra/docs/datastax-astra-database-limits.html)
