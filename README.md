...
## Code Generation
  ...
  * [Bitloops](https://bitloops.com/) — Bitloops is a dedicated Frontend Co-Pilot that helps developers with all the tasks when converting design into code. It analyzes the entire design and generates well-structured, component-based, professional code in minutes. It integrates directly into Figma and your IDE. Bitloops offers free asset extraction (images, text, color palette and CSS). Credits required for more complex code generation. 
