...
## APIs, Data, and ML
  ...
  * [MostExpensiveWatches](https://mostexpensivewatches.net/api) - Documented luxury-watch auction records: 1,156 verified hammer prices (1996–2026) with venue, reference and primary-source links. Completely free: no-auth REST API + bulk JSON datasets (OpenAPI 3.1, CC-BY 4.0), plus a hosted MCP server for AI agents. No key or card required.
