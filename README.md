...
## APIs, Data, and ML
  ...
  * [Japan Neighborhoods API](https://japanneighborhoods.com/developers) - Free REST API for Tokyo neighborhood crime statistics covering 5,078 areas (2018-2024), sourced from Tokyo Metropolitan Police open data. Five endpoints: wards, neighborhoods, safety rankings, crime trends, and neighborhood detail. No auth required. CC BY 4.0.
