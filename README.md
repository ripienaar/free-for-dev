...
## Generative AI
  ...
  * [Groq](https://groq.com) - Ultra-low-latency LLM inference API with a free developer tier and free API key. Rate-limited free usage for models such as Llama and GPT-OSS; paid on-demand token pricing available when you scale.
