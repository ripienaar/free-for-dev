...
## APIs, Data, and ML
  ...
  * [CoinLobster](https://coinlobster.com/developers) - Crypto whale trade API combining 15 exchanges and on-chain DEXes on Ethereum, Base and Arbitrum. Free tier does not require an API key or an account. Public REST endpoints can be accessed via a keyless MCP server.
