...
## APIs, Data, and ML
  ...
  * [MockAPI Builder by webtoolz](https://webtoolz.dev/json/mock-api) — Build multi-endpoint mock REST APIs in the browser with faker data, conditional and sequence responses, and auto-generated docs. Config is encoded in the URL so there's no backend or signup. Completely free.
