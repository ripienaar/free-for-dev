...
## Design and UI
  ...
  * [IconKing](https://iconking.net) - Free browser-based Lottie animation tool. Preview .json/.lottie files, edit colors across all layers, and convert between Lottie JSON and dotLottie format. 100% client-side, no upload or account required.
