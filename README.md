...
## Generative AI
  ...
  * [CoderPlan](https://coderplan.ai) - LLM API gateway with an OpenAI-compatible interface. Free trial credit for new users. Pay-per-use access to Claude, GPT, Gemini, DeepSeek, and Grok. One-line config for Claude Code, Codex CLI, and Gemini CLI.
