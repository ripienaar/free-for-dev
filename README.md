...
## APIs, Data, and ML
  ...
  *    [Funding Signals](https://funding-signals-api.onrender.com/?utm_source=free-for-dev&utm_medium=directory&utm_campaign=listing) - API that finds companies the moment they raise funding (from public SEC Form D filings), scores them 0-100 as sales leads, and enriches with domain + contact email. Free sample endpoint, no key required.
