...
## Monitoring
  ...
  * [Scraper.AI)(https://scraper.ai) - SaaS that monitors website changes you're interested in and turns it into a consumable API for you to build on. Free 50 extractions and 10000 API calls / month.
