...
## APIs, Data, and ML
  ...
  * [Rotate Pilot](https://rotatepilot.com/developers) - Free aviation data API: airport info by ICAO, live METAR weather, aircraft specs, glossary terms, and a daily pilot quiz. No API key, no signup, unlimited.
