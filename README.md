...
## Generative AI
  ...
  * [AI Dev Tools Directory](https://aidevtools-3qf.pages.dev/) - Free pricing comparison and benchmark suite for 61+ AI coding models. Interactive tools include ROI calculator, value analyzer, and model comparison. Public JSON API with no rate limits. [#opensource](https://github.com/dwylq/ai-dev-tools-directory/)  * [Portkey](https://portkey.ai/) - Control panel for Gen AI apps featuring an observability suite & an AI gateway. Send & log up to 10,000 requests for free every month.
