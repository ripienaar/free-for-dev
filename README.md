...
## Screenshot APIs
  ...
  * [ProxyCrawl.com](https://proxycrawl.com/screenshots-api) - Automate website screenshots while avoiding captchas and blocks with an API. Free tier includes 50 screenshots (one time, not monthly) with all the available functionality.
