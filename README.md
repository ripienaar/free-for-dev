...
## Screenshot APIs
  ...
  * [Rendly](https://rendly-api.fly.dev) — Screenshot and OG image API for developers. Capture URLs, render HTML to images, and generate social preview images from templates. Free tier includes 100 renders/month.
