...
## Generative AI
  ...
  * [MagicKit](https://github.com/kaketiti/magickit) - Free, open-source AI toolbox offering FLUX text-to-image generation, AI writing, and image-to-video creation. No sign-up, no API key, no usage limits on the hosted version, mobile-friendly.
