...
## Security and PKI
  ...
  * [Public Cloud Threat Intelligence](https://cloudintel.himanshuanand.com/) — High confidence Indecator of Compromise(IOC) targeting public cloud infrastructure, A portian is available on github (https://github.com/unknownhad/AWSAttacks). Full list is avaibale via API
...
## PaaS
  ...
  * [Koyeb](https://www.koyeb.com) - Koyeb is a developer-friendly serverless platform to deploy apps globally. Seamlessly run Docker containers, web apps, and APIs with git-based deployment, native autoscaling, a global edge network, and built-in service mesh and discovery. A credit card is not required to get started. Free Instance lets you deploy a web service in Frankfurt, Germany or Washington, D.C., US. 
