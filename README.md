...
## APIs, Data, and ML
  ...
  * [JobsPipe](https://jobspipe.dev) - Jobs data API returning live job postings from 30+ ATS feeds and job boards in one normalized JSON schema, plus a company tech-stack scanner. The free plan includes 1,000 jobs per month, all sources and 3 saved-search alerts, no credit card required.
