...
## APIs, Data, and ML
  ...
  * [CrawlGraph](https://crawlgraph.com) - Backlink and domain-link data API built on Common Crawl's open web graph (120M domains, 4.4B links, updated quarterly). The free plan includes 15 API calls per month with the key sent by email, no card needed.
