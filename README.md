...
## APIs, Data, and ML
  ...
  * [GcrawlAI](https://gcrawlai.com/) - Crawls websites and converts them into clean, LLM-ready Markdown or structured data, with SERP results, screenshots, and prebuilt extractors. Handles JavaScript rendering, proxy rotation, and anti-bot evasion through a tiered stealth browser stack, and ships a Chrome extension alongside the API. The free plan includes 200 requests per month with no credit card required, and no credit system — one request counts as one request.
