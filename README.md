...
## Forms
  ...
  * [InboxForm](https://github.com/BenjaminK1ng/inboxform) - Form backend API with usage metering, webhooks, and optional AI reply drafts. Free tier: unlimited forms, 100 submissions per month per form, no signup required. Self-hostable (zero-dependency Node + SQLite, one Dockerfile).
