...
## Miscellaneous
  ...
  * [Mello](https://mello.tools/) - 120+ browser-only utility tools (JSON/CSS formatters, image and PDF tools, password generator, color tools). Free, no signup, runs entirely client-side.
