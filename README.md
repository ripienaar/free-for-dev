...
## Generative AI
  ...
  * [Bifrost by Maxim AI](https://getmaxim.ai/bifrost) - Bifrost is an open-source high-performance AI gateway that unifies access to 15+ providers (OpenAI, Anthropic, AWS Bedrock, Google Vertex, and more) through a single OpenAI-compatible API. Deploy in seconds with zero configuration and get provider fallback, virtual key management, and built in observability for free with the OSS version. [#opensource](https://github.com/maximhq/bifrost)
