...
## APIs, Data, and ML
  ...
  * [Halal Terminal](https://api.halalterminal.com/) - Shariah-compliant stock and ETF screening API across 5 methodologies (AAOIFI, DJIM, FTSE, MSCI, S&P), with purification rates and zakat calculation. Free tier with 500 tokens/month, all endpoints included.
