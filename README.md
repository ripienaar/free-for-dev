...
## APIs, Data, and ML
  ...
  * [checkip.tools](https://checkip.tools) - Free IP and network toolbox (IP lookup, DNS, WHOIS, ping, port checker) with a free, no-key JSON API returning the caller's public IP, IP family and country. No signup, available in 18 languages.
