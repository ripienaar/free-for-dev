...
## Security and PKI
  ...
  * [SnapEnv](https://snapenv.io/#pricing) - Secure environment variable manager for dev teams. AES-256-GCM encryption at rest, CLI, Kubernetes operator, and audit log. Free plan includes 3 projects, 3 members, and 3 environments per project, forever.
