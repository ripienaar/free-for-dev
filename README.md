...
## Other Free Resources
  ...
  * [Aye.so](https://aye.so) - Design your link-in-bio in bento style using widgets. You can create a cool page using the widgets like contact form, images, subscribe, job post, and gifs.
