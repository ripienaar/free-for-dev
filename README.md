...
## Security and PKI
  ...
  * [CSR.plus](https://csr.plus) - Generate certificate signing requests and private keys via a free REST API, no OpenSSL needed. No signup or API key required; keys are generated in memory and never stored or logged.
