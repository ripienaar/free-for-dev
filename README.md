...
## Monitoring
  ...
  * [onWatch](https://github.com/onllm-dev/onwatch) — Free, open-source CLI that monitors AI API quota usage across 6 providers (Anthropic, OpenAI, GitHub Copilot, and more). Background daemon, <50MB RAM, SQLite storage, zero telemetry. 100% free and open-source.
