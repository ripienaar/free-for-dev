...
## APIs, Data, and ML
  ...
  * [BGPT](https://bgpt.pro/) — Scientific paper evidence API/MCP returning structured experimental fields (methods, results, limitations, DOI). Free tier includes 50 searches.
