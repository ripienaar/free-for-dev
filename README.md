...
## APIs, Data and ML
  ...
  * [file.coffee](https://file.coffee/) - An platform where you can store up to 15MB/file (30/MB file with an account).
  ...
  * [nsfw.rest](https://nsfw.rest) - Free API to scan images for NSFW content and files for malware. 100 request per second.
