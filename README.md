...
## Security and PKI
  ...
  * [FileScanAPI](https://filescanapi.com/) — Real-time file malware/virus detection API. Send us your file and we will tell you if it's safe. Free 50 real-time scans/month.
