...
## Email
  ...
  * [Inboxes App](https://inboxesapp.com) — Create up to 3 temporary emails a day, then delete them when you're done. Perfect for testing signup flows.
     - [SPF, DKIM and DMARC check tool](https://inboxesapp.com/simple-dmarc-spf-dkim-checker/) Quickly check that SPF, DKIM and DMARC is set up correctly for free.
