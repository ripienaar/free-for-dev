...
## APIs, Data, and ML
  ...
  * [SportScore](https://sportscore.com/developers/) - Free REST API + iframe widget for football (soccer), basketball, cricket and tennis live scores, fixtures, standings and stats. No API key, no signup. ~10k req/24h/IP. Requires a "Powered by SportScore" dofollow attribution link on pages rendering the data.
