...
## APIs, Data, and ML
  ...
  * * [ByKaranteli](https://bykaranteli.com/developers) — Free crypto futures data API without auth: funding rates across 6 exchanges, Fear & Greed index, liquidation maps, open interest, verifiable signal track record. No rate-limit tiers to buy; public endpoints cached and CORS-enabled.
