...
## Generative AI
  ...
  * [KeyoAPI](https://www.keyoapi.xyz/free-models) - OpenAI-compatible AI API relay with permanently free `*-free` model IDs (DeepSeek, GLM, Kimi). No credit card. Fair-use limits on the free channel; paid model IDs for production.
