...
## APIs, Data, and ML
  ...
  * [flaky](https://flakyapi.dev) - Fake REST API with the same resources as JSONPlaceholder, plus per-request chaos controls: force any status code, add latency, or set a failure rate from the query string. Free tier is 1,000 requests/day anonymously, 10,000 with a free key that needs no confirmation email.
