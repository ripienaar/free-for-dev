...
## APIs, Data, and ML
  ...
  * [JSONUtil.com](https://jsonutil.com) — A free online JSON toolkit with 7 tools: validator, formatter, converter (CSV/XML/YAML), diff, JSONPath tester, schema generator, and tree viewer. 17 developer guides and tutorials. Works entirely in the browser, no signup required.
