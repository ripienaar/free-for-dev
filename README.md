...
## Monitoring
  ...
  * [Prismix](https://prismix.dev) - Free public JSON API and SVG status badges for the live status of 75+ AI services (OpenAI, Anthropic, Cursor, etc.). No auth required. Free tier also includes email/webhook alerts on starred services.
