...
## APIs, Data, and ML
  ...
  * [APIFreaks](https://apifreaks.com/) - API hub with 60+ production-ready APIs across geolocation, domain, DNS, finance, weather, automation, and utilities. Free tier includes 10,000 credits on signup, no credit card required.
  ...
  * [WhoisFreaks](https://whoisfreaks.com/) - WHOIS and domain intelligence API: WHOIS lookup, historical WHOIS, DNS, SSL, typosquatting detection. Free tier includes 500 API credits on signup, no credit card required.
