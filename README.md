...
## Low-code Platform
  ...
  * [Sling.biz](https://sling.biz) — Open source alternative to Builder.io - A Low-code platform and CMS to create and modify frontend on the fly in NextJS. Free forever drag and drop UI widget editor and open sourced project. Offers a SaaS option with free drag and drop editor and allowing unlimited creation of custom page templates, widgets, and routing."
