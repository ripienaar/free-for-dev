...
## Security and PKI
  ...
  * [CheckMCP](https://checkmcp.dev) - Security and quality audit for MCP (Model Context Protocol) servers: OWASP MCP Top 10 scan and an explainable 0-100 score. Free unlimited web audits, no account required; open-source CLI (uvx audit-mcp).
