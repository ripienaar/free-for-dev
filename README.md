...
## Screenshot APIs
  ...
  * [Statically Screenshot](https://statically.io/docs/using-screenshot/) — A free screenshot API to convert web to image or PDF. Supports desktop and mobile view.
...
## Other Free Resources
  ...
  * [thedev.id](https://thedev.id) — A free domain for developers.
