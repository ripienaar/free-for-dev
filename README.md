...
## APIs, Data, and ML
  ...
  * [ZillAPI](https://zillapi.com) — Unofficial Zillow property data API, MCP and Agent SKILL (Zestimate, photos, schools, taxes, full price history). Free tier: 100 credits ( no credit card required. 
