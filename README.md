...
## APIs, Data, and ML
  ...
  * [biquote](https://biquote.io) - Real-time forex, gold, crypto and index CFD prices over REST and WebSocket, plus OHLC candles and an economic calendar covering 54 countries. Completely free: no API key, no signup, 15,000 requests/min per IP and an unmetered WebSocket stream.
