...
## APIs, Data, and ML
  ...
  * [Freight Invoice to Excel](https://freightinvoicetoexcel.com/api-docs) - Document data extraction API — convert freight invoices, bank statements and business documents (PDF, CSV, images) into structured JSON/CSV. Free tier: 3 requests/day with a free account, no card required.
