...
## APIs, Data, and ML
  ...
  * [AlphaAI](https://alphai.io/developers) - Financial news API
  * [Bride Cognitive API](https://bride.gracestack.se) - Hyperdimensional Computing API for semantic similarity, emotion analysis, and anomaly detection. Free tier: 50 requests/month, interactive demo, no credit card required. and MCP server. Every article gets per-ticker impact analysis, a category, and a 1-10 relevance score, and SEC Form 4 insider filings are turned into scored events. The free tier includes 20 requests per minute and 100 requests per day on both REST and MCP, no card required.
...
## Generative AI
  ...
  * [STIL.AI](https://stil.gracestack.se/outfit) - AI-powered fashion design from text descriptions. Generate custom outfit designs, moodboards, and style explorations. Free generation with watermark; watermark-free from 29 kr. No signup required.
