...
## APIs, Data and ML
  ...
  * [FormX.ai](https://www.formx.ai) - Data Capture API that uses AI to turn physical documents such as Identity Documents, Receipts, Invoices, into structured digital data (JSON). Free plan includes 100 API calls.
