...
## DBaaS
   ...
   * [Unbounded](https://www.unbounded.cloud/) - a NoSQL DBaaS which uses Javascript as a query language. Free tier allows 50,000 reads and writes per month, forever.
    * [Freedb](https://freedb.tech) - Free MySQL cloud database with remote access up to 100Mb in Database Storage with PhpMyAdmin available and unlimited simultaneous connections. 
