...
## APIs, Data, and ML
  ...
  * [MentionsAPI](https://mentionsapi.com) - Check brand mentions, ranks and citations across AI search surfaces (ChatGPT, Claude, Gemini, Perplexity, Google AI Overviews, Bing Copilot). Free: $1 signup credit, no card required.
