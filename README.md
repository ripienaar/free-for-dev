...
## Generative AI
  ...
  * [KeyoAPI](https://www.keyoapi.xyz/free-models) - OpenAI-compatible AI API relay with 4 permanently free LLM model IDs (`deepseek-v4-pro-free`, `deepseek-v4-flash-free`, `glm-5.2-free`, `kimi-k3-free`). No credit card. Fair-use rate/concurrency limits on the free channel (not an unlimited production SLA); paid bare model IDs available for production traffic.
