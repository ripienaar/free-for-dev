...
## APIs, Data, and ML
  ...
  * [CometLLM](https://github.com/comet-ml/comet-llm) - Log, visualize, organize, and search your prompt, prompt templates, prompt variables, prompt chains and other metadata in one convenient UI. We're now open-source!
  * [CometML](https://github.com/comet-ml/comet-examples) - The MLOps platform for experiment tracking, model production management, model registry, and full data lineage, covering your workflow from training straight through to production. Free for individuals and academics.
