...
## APIs, Data, and ML
  ...
  * [SuperCompress](https://supercompress.vercel.app) — LLM context compression API that scores each line against your query, keeping only what matters. Cuts token costs by ~65% while preserving answer quality. Free tier with unlimited API calls for open-source projects and individual developers.
