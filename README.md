...
## Tools for Teams and Collaboration
  ...
  * [OneTake](https://screenrecorder.link) - Chrome tab/screen recorder that does the GIF encoding in the browser with gifski compiled to wasm; WebP, AVIF and MP4 come out of the same pipeline. The free tier stops at 5 minutes and 720p, and there is no watermark on either tier.
