...
## APIs, Data, and ML
  ...
  * [LeadFinder](https://getleadscraper.com/docs.html) - REST API that returns local business leads (name, phone, website, address, rating, category) scraped from Google Maps by niche and city. No API key required, free tier of 10 requests/day, returns JSON.
