...
## APIs, Data, and ML
  ...
  * [SnapAPI](https://api-snap.com) - Multi-tool utility API with 13+ endpoints including QR codes, screenshots, HTML-to-PDF, image resize, hashing, UUID, base64, JWT decode, and URL metadata. The free plan includes 100 API calls per month with no credit card required.
