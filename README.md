...
## Testing
  ...
  * [Kane CLI](https://www.testmuai.com/kane-cli) - AI browser testing from the terminal using plain-English objectives, with native Playwright export. Free Starter plan includes 100 run credits with no credit card required.
