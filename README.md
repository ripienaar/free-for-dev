...
## APIs, Data, and ML
  ...
  * [LinkPeek](https://147.15.103.217.sslip.io:5000) - Free developer utility API with 69+ endpoints: link previews, OpenGraph extraction, QR codes, favicons, security headers, DNS lookups, screenshots, cron parsing. 100 requests/day, no API key required.
