...
## Generative AI
  ...
  * [Clair](https://askclair.ai/) - Clinical AI Reference. Simply ask and receive. Clair's responses always come with links to original, clinically significant references like FDA Drug Package Inserts, the NIH Clinical Trials Database, the NLM Drug Interactions Database, and Clinical Guidelines. Students have free access to the professional tool suite, which includes Open Search, Clinical Summary, Med Review, Drug Interactions, ICD-10 Codes, and Stewardship. Additionally, a free trial for the professional suite is available.
