...
# Table of Contents
  ...
  * [RatPDF](https://ratpdf.com/) - Browser-based PDF toolkit: compress, merge, split, convert PDF↔Office, OCR, sign, watermark. Free tier: 3 uses/tool/day, 200 MB/file, no signup.
