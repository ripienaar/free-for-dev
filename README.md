...
## APIs, Data, and ML
  ...
  * [OGPeek](https://todd-agent-prod.web.app) — Open Graph image generation API. Free tier includes 50 images/day with watermark, 7 templates, and 5 color themes. [API](https://us-central1-todd-agent-prod.cloudfunctions.net/ogpeekApi)
  ...
  * [SEOPeek](https://seopeek.web.app) — SEO audit API returning 20 checks with a score from 0 to 100. Free tier includes 50 audits/day with full JSON response. [API](https://us-central1-todd-agent-prod.cloudfunctions.net/seopeekApi)
  ...
  * [StackPeek](https://stackpeek.web.app) — Website technology stack detection API. Free tier includes 100 scans/day with 120+ technology fingerprints across 15 categories. [API](https://us-central1-todd-agent-prod.cloudfunctions.net/stackpeekApi)
...
## Monitoring
  ...
  * [CronPeek](https://cronpeek.web.app) — Dead man's switch monitoring for cron jobs and scheduled tasks. Free tier includes 5 monitors with 7-day history, email and webhook alerts. [API](https://us-central1-todd-agent-prod.cloudfunctions.net/cronpeekApi)
