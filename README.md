...
## Testing
  ...
  * [Requestly](https://requestly.com/)
    * [Web Debugger](https://requestly.com/products/web-debugger/) — Open-source Chrome Extension to Intercept, Redirect and Mock HTTP Requests. Redirect URLs, Modify HTTP Headers, Mock APIs, Inject custom JS, Modify GraphQL Requests. Alternative to Charles Proxy & Fiddler. Free tier include creating upto 5 rules. Completely free for open source projects.
    * [Mock Server](https://requestly.com/products/mock-server/) — Generate Mock API Endpoints. Define custom HTTP status code & custom headers. Create upto 5 mocks in free tier.
    * [API Client](https://requestly.com/products/api-client/) - Open-source & Web based API Client. Minimal. Free for everyone.
    * [SessionBook](https://requestly.com/products/session-book/) - Open-source Chrome Extension - Session Recording & Replay for Developer & QA teams. Generate Link and Share. Includes Console Logs, Network Logs. Generate Mock APIs directly. Auto-generate bug report via JIRA Issue. Free tier includes upto 10 saved sessions.
